...
function OrderScreen() {
    ...
    const addPayPalScript = () =>{
        ...
        script.src = 'https://www.paypal.com/sdk/js?client-id=AWHVwIkH4vMfULnyy9zv6rGmXl_3RULKiaIalLkxRILer-qfQ6XHK_FuCJ1R3_6Kh5rER7EhDh5bqT8g'
        script.async = true
        script.onload = () => {
            setSdkReady(true)
        }
    ...
    useEffect(() => {
        ...
        }, [dispatch, navigate, order, successPay, id, successDeliver])
